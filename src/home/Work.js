...
const Work = () => {
    return (
        <Row className="work-row">
            ...
            <Col xs="12" lg="4" className="p-5 work-card">
                <img src="illustration.jpg" className="mb-5 illustration" alt="work" />
